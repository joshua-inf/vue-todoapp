...
<template>
    <main>
        <section class="greeting text-center py-5 px-3">
            <div class="row">
                <div class="col-1"></div>
                <div class="col-12 col-md-10">
                    <div class="create shadow p-4 rounded-4">
                        <h1>CREATE A TOOL</h1>
                                        ...
                                        <div class="">
                                            <div class="options row">
                                                <div class="col-12 col-md-4 p-3">
                                                    <label>
                                                        <input v-model="input_category" type="radio" name="category"
                                                            id="category" value="bussiness">
                                                        <div>bussiness </div>
                                                    </label>
                                                </div>
                                                <div class="col-12 col-md-4 p-3">
                        ...
                        <div v-if="loderStatus" id="slider" class="slider text-dark ">
